...
export class LoaiTaiSanManagementListComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    const sb = this.loaitaisanManagementService.isLoading$.subscribe(
